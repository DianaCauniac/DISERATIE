...
const PatientDetail = ({ setDetailView, detailViewPatient }) => {
  ...
  const headers = [
    { label: "Nume", key: "name" },
    { label: "Varsta", key: "age" },
    { label: "Grupa sanguina", key: "bloodGroup" },
    { label: "Inaltime", key: "height" },
    { label: "Greutate", key: "weight" },
    { label: "Ritm cardiac", key: "heartBeat" },
    { label: "Tensiune sistolica", key: "systolicBloodPressure" },
    { label: "Tensiune diastolica", key: "diastolicBloodPressure" },
    { label: "Nivel zahar", key: "sugarLevel" },
  ];
