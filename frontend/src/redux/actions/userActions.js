...
export const getAllUsers = () => async (dispatch) => {
  ...
  try {
    var res = await api.get(`/account/all_users`, {
    ...
    if (res.data.users && !res.data.error) {
      ...
      dispatch({ type: ALL_USERS_ERR, payload: res.data.error });
    }
  } catch (e) {
    dispatch({ type: ALL_USERS_ERR, payload: res.data.error });
  }
...
export const allDoctors = () => async (dispatch) => {
  try {
    var res = await api.get(`/account/allDoctors`, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    console.log(res);
    if (res.data.doctors && !res.data.error) {
      dispatch({ type: ALL_DOCTORS, payload: res.data.doctors });
    } else {
      dispatch({ type: ALL_USERS_ERR, payload: res.data.error });
    }
  } catch (e) {
...
export const allDoctorsByNurse = (nurse) => async (dispatch) => {
  try {
    var res = await api.get(`/account/allDoctorsByNurse/${nurse}`, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    console.log(res);
    if (res.data.doctors && !res.data.error) {
...
export const allNurses = () => async (dispatch) => {
  try {
    var res = await api.get(`/account/allNurses`, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    console.log(res);
    if (res.data.nurses && !res.data.error) {
      dispatch({ type: ALL_NURSES, payload: res.data.nurses });
    } else {
      dispatch({ type: ALL_USERS_ERR, payload: res.data.error });
    }
  } catch (e) {
...
export const handleApprove = (data) => async (dispatch) => {
  // dispatch({ type: ALL_USERS_REQ });
  try {
    var res = await api.post(`/account/handleApprove`, data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    console.log(res);
    if (res.data.users && !res.data.error) {
...
export const handleNurseAssignment = (data) => async (dispatch) => {
  // dispatch({ type: ALL_USERS_REQ });
  try {
    var res = await api.post(`/account/handleNurseAssignment`, data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    console.log(res);
    if (res.data.doctor && !res.data.error) {
      dispatch({ type: SELECTED_DOCTOR, payload: res.data.doctor });
    } else {
      dispatch({ type: ALL_USERS_ERR, payload: res.data.error });
    }
  } catch (e) {
...
export const updateProfileName = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_name", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const updateProfile = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_user_profile", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const updateProfileComplete = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_profile_complete", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
        type: ShowSnack,
        payload: "Profile Status Updated!",
      });
      dispatch({ type: UProfile, payload: res.data.user });
    } else {
      localStorage.removeItem("token");
...
export const updateProfileDiscord = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_discord", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const updateProfileComunity = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_comunity", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const updateProfileLookingFor = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_lookingFor", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const updateProfileEmail = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_email", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const updateProfilePassword = (data) => async (dispatch) => {
  try {
    var res = await api.post("/account/update_password", data, {
      headers: { authorization: `${localStorage.getItem("token")}` },
    });
    if (res.data.user && !res.data.error) {
      dispatch({
...
export const resetPassword = (data) => async (dispatch) => {
  try {
    dispatch({ type: PASSWORD_CHANGE_REQ });
    var res = await api.post("/account/reset-password", data);
...
export const newPassword = (data) => async (dispatch) => {
  try {
    dispatch({ type: PASSWORD_CHANGE_REQ });
    var res = await api.post("/account/new-password", data);
    if (res.data && !res.data.error) {
      dispatch({
        type: ShowSnack,
        payload: "Password updated Successfully!",
      });
      dispatch({ type: PASSWORD_CHANGE, payload: true });
    } else {
      dispatch({ type: PASSWORD_CHANGE_ERR, payload: res.data.error });
    }
  } catch (e) {
